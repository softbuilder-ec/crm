...
<html class="bg-gray">
	<head>
		<title>Portal de atenci&oacute;n al cliente - SoftBuilder Cia. Ltda</title>
	...
	<body class="bg-gray">
		<div class="form-box" id="login-box">
    		<div class="header" style="font-weight: 400;">Portal de atención al cliente<br/>SoftBuilder Cia. Ltda</div>
