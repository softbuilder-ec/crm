  ...
  $log->debug("Exiting get_contactsforol method ...");
	...
	*/
	...
	public static function getPortalEmailContents($entityData, $password, $type='') {
		...
		$portalURL = '<a href="'.$PORTAL_URL.'" style="font-family:Arial, Helvetica, sans-serif;font-size:12px; font-weight:bolder;text-decoration:none;color: #4242FD;">'.getTranslatedString('Por favor ingrese aquí', $moduleName).'</a>';
