...
<html>
	<head>
		<title>CRM - SoftBuilder Cia. Ltda.</title>
								...
								<div class="span6">
									<div class="login-area">
										<div class="login-box" id="loginDiv">
											<div class="">
												<h3 class="login-header">Iniciar sesión en CRM<br> SoftBuilder Cia. Ltda</h3>
		</div>
					...
					<div class="row-fluid">
						<div class="span6 pull-left" >
							<div class="footer-content">
								<small>&#169 SoftBuilder Cia. Ltda.</small>
							</div>
						</div>
